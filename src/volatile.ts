 ...
 * previously-authored file, a golden fixture against a fresh run) report
 * "stale"/"different" immediately, even with zero real drift. Everything
 * else (the actual detected facts) still gets compared exactly.
 */
